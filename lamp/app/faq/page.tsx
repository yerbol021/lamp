...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "В связи с тем, что лампы являются аналогом солнечного света и исключают попадания вредного ультрафиолета типа Б и С, ребенка можно светить без ограничения времени. Это подтверждено инструкциями по эксплуатации, которые основаны на научных исследованиях. \n Исходя из нашего опыта, мы рекомендуем следующую периодичность: 1. Лампа двойная на штативе: свечение без ограничения 2. Светодиодная лампа (диод12 или диод24): 6 часов свечения, 2 часа отдыха. Не забывайте, ребенок всегда должен находиться под присмотром!",
  },
  {
